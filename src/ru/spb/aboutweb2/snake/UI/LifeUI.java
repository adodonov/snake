...
public class LifeUI {
    ...
    private JFrame initLifeGUI() {
        ...
        uiState.setCellSize(37);
        uiState.setFocus(new Coords(0, 0));
        uiState.setFirstClick(new Coords(0, 0));
        uiState.setZoomCenter(new Coords(0, 0));

        lifePanel.initSettings(WINDOW_WIDTH/2, WINDOW_HEIGHT/2);      
